...
//        double totalCost;
        ...
        //Allows program to read whatever the user types on the keyboard.
        Scanner in = new Scanner(System.in);
        System.out.println("Enter the total distance in miles: ");
        //read what the user types, look for anything with a decimal, and put it into the variable
        ...
        //prints the value of totalCost inline with the literal
